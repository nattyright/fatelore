...
'Your Servant’s personality and how well they work with their potential master.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Your Servant’s backstory. Remember to make it fit the setting of the RP and have it not break the rules of the Fate series. It is recommended you read the <b>#roleplay-lore</b> section for any further questions on the setting.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Anything you feel needs clarification goes here. For example, your Servant’s <b>wish</b>, <b>quirks</b>, and any <b>trivia</b> that can help you flesh out the character.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'You can choose to describe how your character looks, or you can post a face claim or drawing of them in the Gallery section.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Details on your Servant’s weapon(s) go here, if needed.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'You should at least include 1. Why your Servant has this NP/how does it relate to them 2.  What your Servant can accomplish with their Rank of the Noble Phantasm along with its limitations, if any.<br><br>If the NP has a chant, include it here as well.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Example(s) of usage, if applicable.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'You should at least include 1. Why your Servant has this NP/how does it relate to them 2.  What your Servant can accomplish with their Rank of the Noble Phantasm along with its limitations, if any.<br><br>If the NP has a chant, include it here as well.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Example(s) of usage, if applicable.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Your Servant’s Skills that are tied to their Class. Simply look at Fate/Grand Order Wiki or Type-Moon Wiki for reference on what skills each Class usually has. (Example: Independent Action for Archers, Territory Creation for Casters etc.)<br><br>A description of why this skill pertains to your Servant specifically is also necessary. In addition, include what your Servant can accomplish with their Ranks of Class Skills.<br><br>Please note that skill restrictions exist on this server. For a detailed list of them, please refer to the help section on the google doc template, or ask us on discord.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Your Servant’s Skills that are tied to their Class. Simply look at Fate/Grand Order Wiki or Type-Moon Wiki for reference on what skills each Class usually has. (Example: Independent Action for Archers, Territory Creation for Casters etc.)<br><br>A description of why this skill pertains to your Servant specifically is also necessary. In addition, include what your Servant can accomplish with their Ranks of Class Skills.<br><br>Please note that skill restrictions exist on this server. For a detailed list of them, please refer to the help section on the google doc template, or ask us on discord.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Your Servant’s Skills that are tied to their Class. Simply look at Fate/Grand Order Wiki or Type-Moon Wiki for reference on what skills each Class usually has. (Example: Independent Action for Archers, Territory Creation for Casters etc.)<br><br>A description of why this skill pertains to your Servant specifically is also necessary. In addition, include what your Servant can accomplish with their Ranks of Class Skills.<br><br>Please note that skill restrictions exist on this server. For a detailed list of them, please refer to the help section on the google doc template, or ask us on discord.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
...
'Please include a description of what your Servant can accomplish with their Ranks of Personal Skills.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Your Servant’s Skills that are either unique to them, or similar to existing Skills shared by other Servants. They are usually based on personal traits or the Servant’s biography, so make sure that they are accurate to your Servant’s history. Some Servants share the same Skills, but under different Ranks (Example: Charisma, Mind’s Eye, Innocent Monster etc.)<br><br>Please note that skill restrictions exist on this server. For a detailed list of them, please refer to the help section on the google doc template, or ask us on discord.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Please include a description of what your Servant can accomplish with their Ranks of Personal Skills.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Your Servant’s Skills that are either unique to them, or similar to existing Skills shared by other Servants. They are usually based on personal traits or the Servant’s biography, so make sure that they are accurate to your Servant’s history. Some Servants share the same Skills, but under different Ranks (Example: Charisma, Mind’s Eye, Innocent Monster etc.)<br><br>Please note that skill restrictions exist on this server. For a detailed list of them, please refer to the help section on the google doc template, or ask us on discord.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>',
'Please include a description of what your Servant can accomplish with their Ranks of Personal Skills.<h5><b>BOLD and <i>ITALIC</i> formatting will NOT translate to Google Docs when you generate the sheet. They only exist as visual aid.</b></h5>'
